...
import { EncodeResult } from "./EncodeResult.mjs"
...
export class Tok {
    ...
    tokenizeAsOffsets(text) {
        let functionCleanupArena = new diplomatRuntime.CleanupArena();
        
        const textSlice = functionCleanupArena.alloc(diplomatRuntime.DiplomatBuf.str8(wasm, text));
        
        const result = wasm.Tok_tokenize_as_offsets(this.ffiValue, ...textSlice.splat());
    
        try {
            return new EncodeResult(diplomatRuntime.internalConstructor, result, []);
        }
