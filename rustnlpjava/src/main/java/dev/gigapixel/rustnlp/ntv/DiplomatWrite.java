...
public class DiplomatWrite {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rustnlp_h.C_POINTER.withName("context"),
        rustnlp_h.C_POINTER.withName("buf"),
        rustnlp_h.C_LONG.withName("len"),
        rustnlp_h.C_LONG.withName("cap"),
        rustnlp_h.C_BOOL.withName("grow_failed"),
        MemoryLayout.paddingLayout(7),
        rustnlp_h.C_POINTER.withName("flush"),
        rustnlp_h.C_POINTER.withName("grow")
    ...
    public static class flush {
        ...
        private static final MethodHandle UP$MH = rustnlp_h.upcallHandle(flush.Function.class, "apply", $DESC);
    ...
    public static class grow {
        ...
        private static final MethodHandle UP$MH = rustnlp_h.upcallHandle(grow.Function.class, "apply", $DESC);
