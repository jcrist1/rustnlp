...
public class TokenSpan_option {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            TokenSpan.layout().withName("ok")
        ).withName("$anon$19:34"),
        rustnlp_h.C_BOOL.withName("is_ok"),
        MemoryLayout.paddingLayout(7)
    ).withName("TokenSpan_option");
    ...
    private static final GroupLayout ok$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$19:34"), groupElement("ok"));
